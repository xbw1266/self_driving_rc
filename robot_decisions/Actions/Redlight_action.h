...
class RedlightAction : public ActionNode {
 public:
  RedlightAction(Blackboard::Ptr &blackboard) : ActionNode::ActionNode("redlight_action", blackboard)
  {
	keys_pub_ = nh_.advertise<std_msgs::String>("/keys",1,true);
	
  }

  virtual ~RedlightAction() = default;
