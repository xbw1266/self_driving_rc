...
if image.shape != (IMAGE_SIZE,IMAGE_SIZE,1):
...
model.add(Convolution2D(32,3,3,subsample=(2,2),activation='relu',input_shape=(IMAGE_SIZE,IMAGE_SIZE,1)))
...
model.fit(X_train, Y_train1, validation_split=0.2, shuffle=True, nb_epoch=5)
